package com.mtsmda.hibenateOnly.hibenateOnly.model.mappingCollectionComponents;
...
public class Customer implements Serializable {
	...
	@JoinTable(name = "Address", joinColumns = @JoinColumn(referencedColumnName = "customer_id") )
	private Set<Address> contacts = new HashSet<>();
